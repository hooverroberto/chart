<div>
        ...
        <div class="col-12">
            <div class="card card-chart">
                <div class="card-header ">
                    ...
                    <div class="col-12">
                        <form id="fechaForm" action="{{ route("update_data") }}" method="POST">
                            @csrf
                                            ...
                                            <form method="POST" action="{{ route('add_value') }}">
                                                ...
                                                <div class="form-group">
                                                    <label for="performance"
                                                        class="form-label fs-6 fw-semibold">Rendimiento
                                                        del empleado:</label>
                                                    <input type="number" class="form-control fs-6" id="performance"
                                                        name="performance" placeholder="Ingresa el rendimiento"
                                                        required>
                                                </div>
    ...
    <script>
        const selectElem = document.querySelector("#fecha");
        selectElem.addEventListener("change", () => {
            let myForm = document.getElementById("fechaForm");
            myForm.submit();
            // $.ajax({
            //     url: 'productos/all',
            //     method: 'POST',
        ...
        // selectElem.addEventListener("change", () => {
        //     // alert(JSON.parse(`<?php print_r($dataJson); ?>`))
        //     const chartData = JSON.parse(`<?php echo $dataJson; ?>`)
        //     const ctx = document.getElementById('charts-reportes');
